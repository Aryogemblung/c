...
repo="https://raw.githubusercontent.com/Aryogemblung/c/main/"
...
data_ip="https://raw.githubusercontent.com/Aryogemblung/c/main/ip"
checking_sc() {
...
clear
cd
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/Aryogemblung/c/main/limit/quota"
chmod +x /usr/local/sbin/quota
cd /usr/local/sbin/
sed -i 's/\r//' quota
clear
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/Aryogemblung/c/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
clear
wget -q -O /usr/bin/limit-ip-ssh "https://raw.githubusercontent.com/Aryogemblung/c/main/limit/limit-ip-ssh"
chmod +x /usr/bin/*
cd /usr/bin
...
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/Aryogemblung/c/main/ws/ws-ovpn.py
...
insbkp() {
wget -q https://raw.githubusercontent.com/Aryogemblung/c/main/limit/installbckp.sh && chmod +x installbckp.sh && ./installbckp.sh
clear
}
...
insmenu() {
wget -q https://raw.githubusercontent.com/Aryogemblung/c/main/up/up.sh && chmod +x up.sh && ./up.sh
clear
}
...
UDP="https://raw.githubusercontent.com/Aryogemblung/c/main/udp/"
# install udp-custom
...
USRID=$(curl https://raw.githubusercontent.com/Aryogemblung/c/main/ip | grep $ipsaya | awk '{print $2}')
USREXP=$(curl https://raw.githubusercontent.com/Aryogemblung/c/main/ip | grep $ipsaya | awk '{print $3}')
TIME=`date -d "0 days" +"%d-%m-%Y" `
TIMEZONE=$(printf '%(%H:%M:%S)T')
TEXT="
<code>────────────────────</code>
<b>⚠️AUTOSCRIPT PREMIUM C1⚠️</b>
<code>────────────────────</code>
