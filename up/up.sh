...
wget https://raw.githubusercontent.com/Aryogemblung/c/main/up/menu.zip
unzip menu.zip
chmod +x menu/*
...
wget -q https://raw.githubusercontent.com/Aryogemblung/c/main/versionbaru -O /usr/local/sbin/version
